...
<body class="front-page">
  ...
  <section class="section trademark">
    <div class="container">
      <div class="separator"></div>
      <h2 class="section-title trademark-title">собственные <span>торговые</span> марки</h2>
      ...
      <div class="clients-wrapper">
            ...
            <ul class="clients-content-list">
              <li class="clients-content-item">
                <svg class="clients-content-icon" width="30" height="30">
                  <use href="img/sprite.svg#сhemical"></use>
                </svg>
        ...
        <div class="clients-logo">
          <a href="#" class="clients-logo-item">
            <img src="img/clients-logo.svg" alt="логотип клиента" class="clients-logo-icon">
          </a>
          <a href="#" class="clients-logo-item">
            <img src="img/clients-logo.svg" alt="логотип клиента" class="clients-logo-icon">
          </a>
      ...
      <div class="swiper blog-slider">
        ...
        <div class="swiper-wrapper">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img src="img/blog/blog-photo1.jpg" alt="слайд 1" class="blog-card-img">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img src="img/blog/blog-photo2.jpg" alt="слайд 2" class="blog-card-img">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img src="img/blog/blog-photo1.jpg" alt="слайд 3" class="blog-card-img">
            <h3 class="blog-card-title">Современная методология разработки одухотворила всех причастных</h3>
            <p class="blog-card-text">
              Действия представителей оппозиции, превозмогая сложившуюся непростую экономическую ситуацию, в&nbsp;равной
              степени предоставлены...
